    ...
    showMenu(
      ...
      items: [
        ...
        PopupMenuItem(
          ...
          onTap: () {
            // Need to use Future.delayed because onTap can't directly navigate
...
// Add this helper method for getting provider icons
  IconData _getProviderIcon(ApiProvider provider) {
    switch (provider) {
...
// Add this method to build reference chips
  ...
  Widget _buildQuestionInput(HomeController controller) {
    final hasApiConfig = controller.activeApiConfig != null;
      ...
      children: [
        Expanded(
          child: TextField(
            ...
            decoration: InputDecoration(
              hintText: hasApiConfig
                  ? 'Ask your second brain...'
                  : 'Configure API in Settings to ask questions',
              filled: true,
              ...
              // Improved prefix icon presentation
              prefixIcon: hasApiConfig
                  ? Container(
                      margin: const EdgeInsets.only(left: 12, right: 8),
                      child: Icon(
                        _getProviderIcon(controller.activeApiConfig!.provider),
                        size: 20,
                        color: Theme.of(context).colorScheme.primary,
                      ),
                    )
                  : null,
              prefixIconConstraints: hasApiConfig
